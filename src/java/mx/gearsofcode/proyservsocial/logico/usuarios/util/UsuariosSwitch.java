 ...
 * @generated
 */
public class UsuariosSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case UsuariosPackage.ALUMNO: {
            ...
            if (result == null)
                result = caseUsuarioRegistrado(alumno);
            if (result == null)
        ...
        case UsuariosPackage.ADMIN: {
            ...
            if (result == null)
                result = caseUsuarioRegistrado(admin);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case UsuariosPackage.RESPONSABLE: {
            ...
            if (result == null)
                result = caseUsuarioRegistrado(responsable);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case UsuariosPackage.USUARIO_REGISTRADO: {
            UsuarioRegistrado usuarioRegistrado = (UsuarioRegistrado) theEObject;
            T result = caseUsuarioRegistrado(usuarioRegistrado);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Usuario Registrado</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Usuario Registrado</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseUsuarioRegistrado(UsuarioRegistrado object) {
        return null;
    }
