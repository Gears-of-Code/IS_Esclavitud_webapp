    ...
    <div id="info">
        ...
        for(int i=0; i<respPendientes.length; i++){
            out.println("<div class='entrada'>");
                out.println("<div class='button button-aceptar' pg='acep-resp.jsp?id_p="+respPendientes[i][0]+"'>Aceptar</div>");                
                out.println("<div class='button button-consultar' pg='perf-res.jsp?id_p="+respPendientes[i][0]+"'>Perfil</div>");
                out.println("<div class='button button-rechazar' pg='acep-resp.jsp?id_p="+respPendientes[i][0]+"'>Rechazar</div>");
